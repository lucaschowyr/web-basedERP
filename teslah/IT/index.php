          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <div class="page-header-title">
                <h5 class="m-b-10">IT Dashboard</h5>
              </div>
              <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                <li class="breadcrumb-item"><a href="index.php">IT Dashboard Analytics</a></li>
              </ul>
            </div>
          </div>
        </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        ...
                        <div class="d-inline-block align-middle">
                          <img src="../images/users/user-img.png" alt="user image" class="img-radius wid-40 align-top m-r-15">
                          <div class="d-inline-block">
                            <h6>John</h6>
                          ...
                          <td class="b-none">
                            <a href="#!" class="align-middle">
                              ...
                              <div class="d-inline-block">
                                ...
                                <p class="text-muted m-b-0">IT Manager</p>
                              </div>
                            </a>
                          </td>
                        </tr>
            ...
            <div class="card-body">
              <div class="row m-b-20 received-chat">
                <div class="col-auto p-r-0">
                  <img src="../images/users/ivy203.png" alt="user image" class="img-radius wid-40">
                </div>
                <div class="col">
                  <div class="msg">
